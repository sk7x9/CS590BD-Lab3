...
public class Operations {
	...
	public static void connectSSH()
	{
		...
		try {
		    ...
		    ssh.uploadSingleDataToServer("c://sk7x9.txt", "/home/cloudera/");
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseCreate/Lab3sk7x9/GeoLocation:Date:Accelerometer");
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseInsert/Lab3sk7x9/-home-cloudera-sensordata.txt/GeoLocation:Date:Accelerometer");
	            BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream()));
	            String inputLine; 
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseRetrieveAll/Lab3sk7x9");
	            BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream()));
	            String inputLine; 
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbasedeletel/Lab3sk7x9");
	            BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream()));
	            String inputLine; 
